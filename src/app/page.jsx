        ...
        <div className="h-full w-full backround-oplan flex items-end justify-center md:px-10 lg:px-20">
          <div className="flex flex-col md:flex-row items-center justify-center h-[90%]  container mx-auto">
            <div className=" h-full w-full order-2 md:order-1 flex flex-col items-center md:items-start justify-start md:justify-center">
              ...
              <a
                src="/"
                className={`flex items-center relative z-[50] gap-x-2 bg-red-500 md:float-start font-display bg-gradient-to-br bg-gradient-to-r from-[#31D0E6] from-10% via-[#31A8E5] via-30% to-[#1F81C8] to-90% bg-[length:400%] rounded-[30px] z-10 hover:animate-gradient-xy hover:bg-[length:100%] before:content-[''] before:absolute before:-top-[5px] before:-bottom-[5px] before:-left-[5px] before:-right-[5px] before:bg-gradient-to-r before:from-sky-500 before:from-10% before:via-sky-200 before:via-30% before:to-green-500 before:bg-[length:400%] before:-z-10 before:rounded-[35px] before:hover:blur-xl before:transition-all before:ease-in-out before:duration-[1s] before:hover:bg-[length:10%] active:bg-white focus:ring-white p-4 px-10 rounded-sm  border-2 border-[#2FC1FF] drop-shadow-lg mt-2 lg:mt-6 hover:scale-125 transition-all ease-in-out duration-200 cursor-pointer ${
                  show2000Delay
